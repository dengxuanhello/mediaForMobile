...
import org.m4m.effects.MixAudioEffect;
...
public class ComposerAudioEffectCoreActivity extends ComposerJoinCoreActivity {
    ...
    protected void setTranscodeParameters(MediaComposer mediaComposer) throws IOException {
        ...
        MixAudioEffect effect = new MixAudioEffect();
        effect.setFileUri1(this,mediaUri1,this.audioFormat);
        effect.setFileUri2(this,mediaUri2,this.audioFormat);
