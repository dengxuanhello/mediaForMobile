...
class VideoCaptureSourcePullSurfaceCommandHandler implements ICommandHandler {
    private IVideoPlaySource source;
    private MediaCodecPlugin plugin;

    public VideoCaptureSourcePullSurfaceCommandHandler(IVideoPlaySource source, MediaCodecPlugin plugin) {
        super();
        this.source = source;
        this.plugin = plugin;
    }
