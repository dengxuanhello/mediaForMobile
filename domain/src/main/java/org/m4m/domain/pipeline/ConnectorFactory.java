...
public class ConnectorFactory {
    ...
    public void connect(IOutputRaw source, IInputRaw transform) {
        ...
        if (source instanceof IVideoPlaySource && transform instanceof Encoder) {
            new PluginConnector(commandProcessor).connect((IVideoPlaySource) source, (Encoder) transform);
            return;
        }

        if (source instanceof IVideoPlaySource && transform instanceof VideoEffector) {
            new PluginConnector(commandProcessor).connect((IVideoPlaySource) source, (VideoEffector) transform);
            return;
        }
    ...
    public Collection<IsConnectable> createConnectionRules() {
        ...
        collection.add(OneToOneConnection(IVideoPlaySource.class, VideoEncoder.class));
        collection.add(OneToOneConnection(IVideoPlaySource.class, VideoEffector.class));
