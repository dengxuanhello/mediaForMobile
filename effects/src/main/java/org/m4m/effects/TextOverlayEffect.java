...
public class TextOverlayEffect extends OverlayEffect {
    ...
    public TextOverlayEffect(WaterMarkInfo waterMarkinfo,int angle, IEglUtil eglUtil) {
        super(angle, eglUtil);
    ...
    protected void drawCanvas(Canvas canvas) {
        ...
        if(waterMarkInfo != null && waterMarkInfo.bitmap!=null){
            if(waterMarkInfo.positionX<width
                    &&waterMarkInfo.positionY<height){
                canvas.drawBitmap(waterMarkInfo.bitmap,waterMarkInfo.positionX,waterMarkInfo.positionY,null);
            }
        }
    }
