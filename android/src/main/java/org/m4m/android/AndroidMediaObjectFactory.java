...
public class AndroidMediaObjectFactory implements IAndroidMediaObjectFactory {
    ...
    @Override
    public IPreview createPreviewRender(Object glView, Object mediaSourece) {
        if(mediaSourece instanceof Camera) {
            return new PreviewRender((GLSurfaceView) glView, getEglUtil(), (Camera) mediaSourece);
        }else if(mediaSourece instanceof SimpleExoPlayer){
            return new VideoPreviewRender((GLSurfaceView) glView, getEglUtil(), (SimpleExoPlayer) mediaSourece);
        }
        return null;
    }
    ...
    @Override
    public IVideoPlaySource createVideoPlaySource() {
        return new VideoPlaySource(getEglUtil());
    }
