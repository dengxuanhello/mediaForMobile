...
public class VideoPlaySource extends org.m4m.domain.PlayVideoSource {
    ...
    public VideoPlaySource(IEglUtil eglUtil) {
    ...
    private class SurfaceTextureManager implements SurfaceTexture.OnFrameAvailableListener {
        ...
        private VideoPlaySource.STextureRender textureRender;
        ...
        public SurfaceTextureManager(CommandQueue commandQueue, IEglUtil eglUtil) {
            ...
            this.eglUtil = eglUtil;
            textureRender = new VideoPlaySource.STextureRender(eglUtil);
    ...
    @Override
    public void setSource(Object exoplayer) {
    ...
    private void updateOutputResolution() {
        ...
        if(simpleExoPlayer.getVideoFormat() != null) {
            outputResolution = new Resolution(simpleExoPlayer.getVideoFormat().width, simpleExoPlayer.getVideoFormat().height);
        }
    }
